...
const hero = () => {
  return (
    ...
    <div className='hero-section'>
      ...
      <div id="circle">
        <svg className='text-circle' xmlns="http://www.w3.org/2000/svg" xmlLang="en" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 500 500"><path d="M984.08,540.5V499.25h28.5v93.33H919.25v-28.5H960.5l-53.08-53.25,23.41-23.41Z" transform="translate(-713 -300)" style={{"fill":"#fff"}}/>
            <defs>
...
scheduled to be held in the month of April.The organizing committee of Regalia 2023 has put in
...
and activities, including a fashion show, a group dance competition, a
battle of bands, an instrumental competition and more.The fest will also feature performances by renowned artists and
  celebrities.
      </p>
