...
const Footer = () => {
  return (
    <footer className="mt-6 w-full flex justify-between items-center bg-black rounded-3xl p-6 shadow md:flex md:items-center md:justify-between md:px-12 text-white">
