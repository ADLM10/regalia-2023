    ...
    <>
      {showModal && (
        <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 backdrop-blur-sm z-50 flex justify-center items-center">
          <div
            className=" w-full h-3/4 rounded-lg shadow-lg flex flex-col justify-evenly items-center mx-5 p-5 md:w-1/2 event-modal bg-gradient-to-br from-black to-fuchsia-950 backdrop-blur-sm "
